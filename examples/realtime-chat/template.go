...
<head> 
    <title>{{.roomid}}</title>
    <link rel="stylesheet" type="text/css" href="customhttp://meyerweb.com/eric/tools/css/reset/reset.css"/>
    <script src="customhttp://ajax.googleapis.com/ajax/libs/jquery/1.7/jquery.js"></script> 
    <script src="customhttp://malsup.github.com/jquery.form.js"></script> 
    <script> 
        $('#message_form').focus();
